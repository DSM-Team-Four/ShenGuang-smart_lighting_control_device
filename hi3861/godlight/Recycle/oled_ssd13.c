...
uint32_t OledInit(void)
{
    ...
    IoTGpioSetFunc(13, IOT_GPIO_FUNC_GPIO_13_I2C0_SDA); /* gpio13使用6功能 */
    IoTGpioInit(14); /* 初始化gpio14 */
    IoTGpioSetFunc(14, IOT_GPIO_FUNC_GPIO_14_I2C0_SCL); /* gpio14使用6功能 */

    IoTI2cInit(HI_I2C_IDX_0, OLED_I2C_BAUDRATE);
...
void OledmentTask(const char *arg)
{
    printf("1234\r\n");
    (void)arg;
    printf("12345\r\n");
    ...
    printf("12345678\r\n");
    OledShowString(20, 3, "Hello  World", 1); /* 屏幕�?20�?3行显�?1�? */
    printf("123456789done!\r\n");
}