...
#define SAMPLE_SVP_NNIE_YOLOV3TINY_REPORT_BLOB_NUM 2             /* yolov3tiny report blob num */ //其实就是通道数  channels
#define SAMPLE_SVP_NNIE_YOLOV3TINY_EACH_GRID_BIAS_NUM 6          /* yolov3tiny bias num of each grid */
#define SAMPLE_SVP_NNIE_YOLOV3TINY_EACH_BBOX_INFER_RESULT_NUM (5+12) /* yolov3tiny inference result num of each bbox */
...
typedef SAMPLE_SVP_NNIE_YOLOV2_BBOX_S SAMPLE_SVP_NNIE_YOLOV3TINY_BBOX_S;
