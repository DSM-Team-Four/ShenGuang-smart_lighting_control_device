    ...
    if (s32Signo == SIGINT || s32Signo == SIGTERM) {
        switch (*s_ppChCmdArgv[1]) {
            ...
            case 'b':
                ...
                break;
            case 'c':
                SAMPLE_SVP_NNIE_Yolov3tiny_HandleSig();
                break;
            case 'd':
                SAMPLE_SVP_NNIE_Yolov3tiny_Vivo_HandleSig();
                break;
            case 'e':
...
static void SAMPLE_SVP_Usage(const char *pchPrgName)
{
    ...
    printf("\t c) Yolov3tiny(Read File).\n");
    printf("\t d) Yolov3tiny(VI->VPSS->NNIE->VGS->VO).\n");
...
#endif
{
    ...
    switch (*argv[1]) {
        ...
        case 'b':
            ...
            break;
        case 'c':
            SAMPLE_SVP_NNIE_Yolov3tiny();
            break;
        case 'd':
            SAMPLE_SVP_NNIE_Yolov3tiny_Vivo();
            break;
        case 'e':
